...
export default function ModalProduto({ produto, onFechar, onSalvar, carregando }) {
  ...
  const margem = calcularMargem(form.precoCompra, form.precoVenda);
  ...
  async function handleSubmit(e) {
    ...
    fd.append('precoCompra', form.precoCompra);
        ...
        <form onSubmit={handleSubmit} style={{ padding: '20px 24px', display: 'flex', flexDirection: 'column', gap: 14 }}>
            ...
            >
              ...
              >
                {form.fotoPreview ? (
                  ...
                  <div style={{ width: '100%', height: '100%', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 11, color: 'var(--texto-leve)' }}>
                    Sem foto
                  </div>
                )}
              </div>
              ...
              >
                Clique para selecionar uma imagem (JPG, PNG ou WebP, máx. 5MB)
          ...
          {form.precoCompra && form.precoVenda && (
            <div
              style={{
                padding: '10px 14px',
                background: margem >= 0 ? 'var(--verde-bg)' : 'var(--vermelho-bg)',
                borderRadius: 6,
                fontSize: 12,
                color: margem >= 0 ? 'var(--verde)' : 'var(--vermelho)',
                fontWeight: 500,
              }}
            >
