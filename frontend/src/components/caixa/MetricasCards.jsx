  ...
  return (
    <div style={{ display: 'grid', gridTemplateColumns: `repeat(${colunas}, 1fr)`, gap: 12, marginBottom: 20 }}>
      ...
      >
        ...
        <div style={{ fontFamily: 'Cormorant Garamond, serif', fontSize: isMobile ? 26 : 30, fontStyle: 'italic', color: produtosBaixoEstoque > 0 ? 'var(--vermelho)' : 'var(--texto)', lineHeight: 1 }}>
